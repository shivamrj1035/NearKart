...
import { shops as staticShops, Shop } from "@/data/shops";
import { useLocationStore } from "@/store/useLocationStore";
import { fetchNearbyShopsFromOverpass } from "@/services/overpass";

type SortBy = "distance" | "rating" | "reviews";

export function useShopFilter(initialArea: string = "") {
